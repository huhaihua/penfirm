...
#define CAN_IT_FMP0                 ((uint32_t)0x00000002) /* FIFO 0 message pending中断 */
#define CAN_IT_FF0                  ((uint32_t)0x00000004) /* FIFO 0 full 满中断*/
#define CAN_IT_FOV0                 ((uint32_t)0x00000008) /* FIFO 0 overrun 溢出中断*/
